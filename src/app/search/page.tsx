            ...
            <div className="container mx-auto px-4 py-16">
                ...
                {products.length > 0 ? (
                    ...
                    <div className="text-center py-20 bg-zinc-900 rounded-lg border border-dashed border-zinc-800">
                        <p className="text-lg text-zinc-300 mb-2">No matches found for &quot;{query}&quot;</p>
                        <p className="text-sm text-zinc-500">Try checking your spelling or using different keywords.</p>
                    </div>
                )}
            </div>
        </div>
