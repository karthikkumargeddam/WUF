export default function PrivacyPage() {
    return (
        <div className="container mx-auto px-4 py-20 max-w-4xl">
            <h1 className="text-5xl font-black text-white mb-10 uppercase tracking-tighter">Privacy & Security</h1>
            <div className="prose prose-zinc max-w-none space-y-10 text-white prose-p:text-white prose-li:text-white prose-headings:text-white prose-strong:text-white">
                ...
                <section>
                    <h2 className="text-2xl font-black text-white mb-4 uppercase tracking-tight border-l-4 border-white pl-4">Data Collection Protocol</h2>
                ...
                <section>
                    <h2 className="text-2xl font-black text-white mb-4 uppercase tracking-tight border-l-4 border-white pl-4">Utilization</h2>
                ...
                <section>
                    <h2 className="text-2xl font-black text-white mb-4 uppercase tracking-tight border-l-4 border-white pl-4">Industrial-Grade Security</h2>
